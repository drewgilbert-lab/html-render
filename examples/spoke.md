---
# No page class. Frontmatter carries only what has no pixels: page identity and
# the JSON-LD-only nodes. Everything visible is in the body, in render order.
...
current: Share of Voice in AI Search
```
...
> AI Share of Voice is the percentage of tracked brand mentions, a brand's mentions plus every named competitor's mentions, appearing across AI answer engines for a set of tracked prompts. A brand with 40 of 100 mentions holds 40% AI Share of Voice, a share that shifts month over month.

:::section
id: how-does-ai-share-of-voice-work-as-a-measurement
...
:::
:::section
id: why-do-geo-teams-track-ai-share-of-voice
...
:::
:::section
id: how-does-ai-share-of-voice-differ-from-ai
...
label: On this page
items:
  - label: How Does AI Share of Voice Work as a Measurement?
    anchor: how-does-ai-share-of-voice-work-as-a-measurement
  - label: Why Do GEO Teams Track AI Share of Voice?
    anchor: why-do-geo-teams-track-ai-share-of-voice
  - label: How Does AI Share of Voice Differ From AI Mention Rate?
    anchor: how-does-ai-share-of-voice-differ-from-ai
  - label: FAQ
    anchor: faq
button:
